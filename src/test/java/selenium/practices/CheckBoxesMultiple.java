...
public class CheckBoxesMultiple {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		checkbox1.click();
//WebElement checkbox=driver.findElement(By.xpath("//input[@value='Laptop']"));
//checkbox.click();
		...
		List<WebElement> allCheckboxes = driver
				.findElements(By.xpath("//div[@class='widget-content']//input [@name='accessories']"));
		for (int i = 0; i < allCheckboxes.size(); i++) {
			allCheckboxes.get(i).click();
		}
		// byusing for..each loop
		...
		// by using for.....Each
		for (WebElement onebyone : allCheckboxes) {
			String valu1e = onebyone.getAttribute("value");
			if (valu1e.equals("Pen") || valu1e.equals("Laptop")) {
				onebyone.click();
			}
		}
